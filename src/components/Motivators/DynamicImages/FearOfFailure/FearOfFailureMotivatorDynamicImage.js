...
const motivatorMap = [
    ...
    <FearOfFailureMotivatorDynamicImage4SVG id="fear-of-failure-motivator-image" className="fear-of-failure-motivator-image-4" height="100" width="100" />,<FearOfFailureMotivatorDynamicImage2SVG id="fear-of-failure-motivator-image" className="fear-of-failure-motivator-image-2" height="100" width="100" />,
